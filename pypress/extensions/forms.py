...
from wtforms import Form as BaseForm, fields, HiddenField
# validators, widgets, ext

# from wtforms.fields import BooleanField, DecimalField, DataField, \
...
if _is_sqlalchemy:
    ...
    for field in (QuerySelectField, QuerySelectMultipleField):
